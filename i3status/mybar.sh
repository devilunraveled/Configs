...
# bar {
#   status_command exec /home/devilunraveled/.config/i3status/mybar.sh
# }
...
#   echo -n "\"full_text\":\" $(/home/devilunraveled/.config/i3status/crypto.py) \","
#   echo -n "\"color\":\"#000000\","
...
myip_public() {
  ...
  echo -n "\"full_text\":\" $(/home/devilunraveled/.config/i3status/ip.py) \","
  echo -n "\"color\":\"#000000\","
  echo -n "\"background\":\"$bg\","
  common
  echo -n "},"
...
myvpn_on() {
  ...
  separator $bg "#4f6059" # background left previous block
...
disk_usage() {
  ...
  echo -n "\"full_text\":\"  $(/home/devilunraveled/.config/i3status/disk.py)%\","
  echo -n "\"color\":\"#000000\","
  echo -n "\"background\":\"$bg\","
  common
  echo -n "}"
...
memory() {
  ...
  echo -n "\"full_text\":\"  $(/home/devilunraveled/.config/i3status/memory.py)%\","
  echo -n "\"color\":\"#000000\","
  echo -n "\"background\":\"#76adae\","
  common
  echo -n "}"
}
...
cpu_usage() {
  ...
  echo -n "\"full_text\":\"  $(/home/devilunraveled/.config/i3status/cpu.py)% \","
  echo -n "\"color\":\"#000000\","
  echo -n "\"background\":\"#76adae\","
  common
  echo -n "},"
...
#   echo -n "\"full_text\":\" $(/home/devilunraveled/.config/i3status/meteo.py) \","
#   echo -n "\"background\":\"$bg\","
#   common
#   echo -n "},"
# }
...
while read line;
do
  # echo $line > /home/devilunraveled/gitclones/github/i3/tmp.txt
  # {"name":"id_vpn","button":1,"modifiers":["Mod2"],"x":2982,"y":9,"relative_x":67,"relative_y":9,"width":95,"height":22}

  # VPN click
  if [[ $line == *"name"*"id_vpn"* ]]; then
    alacritty -e /home/devilunraveled/.config/i3status/click_vpn.sh &

  # CHECK UPDATES
  elif [[ $line == *"name"*"id_systemupdate"* ]]; then
    alacritty -e /home/devilunraveled/.config/i3status/click_checkupdates.sh &
  ...
  # TIME
    ...
    alacritty -e /home/devilunraveled/.config/i3status/click_time.sh &
