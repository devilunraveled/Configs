...
export const SubGreddiitPage = () => {
  ...
  const getAllSubGreddiits = async () => {
    const getAllSubGResponse = await fetch(`http://localhost:3001/api/subGreddiit/SubGreddiitsPage`, {
      method: 'GET',
        ...
        <Box>
          <Box>
            ...
            <Box
              ...
              >
                <SubGreddiitCard subGreddiits={allSubGreddiits.joinedSubs} type={"joined"} update={handleChange}/>
            </Box>
          </Box>
        </Box>
        <Box>
          <Box>
            <Box
              ...
              >
                <Typography component={"span"}>
                  <h1>Explore Other SubGreddiits</h1>
                </Typography>
            </Box>
            ...
            <Box
              ...
              justifyContent="center"
              >
                <SubGreddiitCard subGreddiits={allSubGreddiits.otherSubs} type={"notJoined"} update={handleChange}/>
            </Box>
          </Box>
        </Box>
    </Box>
