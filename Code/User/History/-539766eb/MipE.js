...
function acceptableUser( subGreddiitId, userId ){
...
export const reportPost = async(req, res) => {
    try{
        ...
        const { subGreddiitId, description , userId } = req.body;
        ...
        if ( !validUser || isBlocked ){
            return res.status(400).json({ message : "User Is Not a Part Of The SubGreddiit." });
        }
        ...
        var newReport = new Report({
            ...
            reportedUser : reportPost.postedBy,
            reportType : "Post",
            reportedText : reportPost.postContent,
