import {
  ...
  const NewSubGreddiitCard = ({ picturePath }) => {
    ...
    const handleNewSubGreddiit = async () => {
      ...
      formData.append("tags", subGreddiit.tags);
      formData.append("bannedWords", subGreddiit.bannedWords);
      ...
      const response = await fetch(`http://localhost:3001/subGreddiit/createNewSubGreddiit`, {
        method: "POST",
